                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-projects--project_id--tasks">POST api/projects/{project_id}/tasks</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-projects--project_id--tasks--id-">
                                <a href="#endpoints-PUTapi-projects--project_id--tasks--id-">PUT api/projects/{project_id}/tasks/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-projects--project_id--tasks--id-">
                                <a href="#endpoints-DELETEapi-projects--project_id--tasks--id-">DELETE api/projects/{project_id}/tasks/{id}</a>
                            </li>
...
Welcome to the **Task Management API** documentation.

This project is a RESTful API built with Laravel that enables authenticated users to manage projects and tasks efficiently. It follows a clean architecture with a Service Layer, Repository Pattern, Policies, Queues, Notifications, and comprehensive Feature Tests.
</code></pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>User full name. Must not be greater than 255 characters. Example: <code>Dina Abdullah</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="dina@example.com"
               data-component="body">
    <br>
<p>User email address. Must be a valid email address. Example: <code>dina@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    \"description\": \"Laravel REST API with authentication and task management.\",
    \"status\": \"active\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Project name. Must not be greater than 255 characters. Example: <code>Task Management API</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Laravel REST API with authentication and task management."
               data-component="body">
    <br>
<p>Project description. Example: <code>Laravel REST API with authentication and task management.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Project status. Example: <code>active</code></p>
Must be one of:
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"name\": \"Updated Task Management API\",
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Updated Task Management API"
               data-component="body">
    <br>
<p>Updated project name. Must not be greater than 255 characters. Example: <code>Updated Task Management API</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Updated project description. Example: <code>Updated project description.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Project status. Example: <code>completed</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>active</code></li> <li><code>completed</code></li> <li><code>archived</code></li></ul>
        </div>
        </form>
...
<div class="bash-example">
    ...
    \"description\": \"Implement Laravel Sanctum authentication.\",
    \"priority\": \"high\",
    \"status\": \"todo\",
    \"due_date\": \"2026-08-15\"
}"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Task title. Must not be greater than 255 characters. Example: <code>Implement authentication</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Implement Laravel Sanctum authentication."
               data-component="body">
    <br>
<p>Task description. Example: <code>Implement Laravel Sanctum authentication.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Task priority. Example: <code>high</code></p>
Must be one of:
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Task status. Example: <code>todo</code></p>
Must be one of:
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Task due date. Must be a valid date. Must be a date after or equal to <code>today</code>. Example: <code>2026-08-15</code></p>
        </div>
        </form>

                    <h2 id="endpoints-PUTapi-projects--project_id--tasks--id-">PUT api/projects/{project_id}/tasks/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost/api/projects/1/tasks/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"title\": \"Finish API Documentation\",
    \"description\": \"Complete API documentation using Scribe.\",
    \"priority\": \"medium\",
    \"status\": \"in_progress\",
    \"due_date\": \"2026-08-20\"
}"
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Finish API Documentation"
               data-component="body">
    <br>
<p>Updated task title. Must not be greater than 255 characters. Example: <code>Finish API Documentation</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="Complete API documentation using Scribe."
               data-component="body">
    <br>
<p>Updated task description. Example: <code>Complete API documentation using Scribe.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>priority</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Task priority. Example: <code>medium</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>low</code></li> <li><code>medium</code></li> <li><code>high</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Task status. Example: <code>in_progress</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>todo</code></li> <li><code>in_progress</code></li> <li><code>done</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Updated due date. Must be a valid date. Example: <code>2026-08-20</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-projects--project_id--tasks--id-">DELETE api/projects/{project_id}/tasks/{id}</h2>
